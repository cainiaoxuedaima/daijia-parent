...
public class DriverInfoServiceImpl extends ServiceImpl<DriverInfoMapper, DriverInfo> implements DriverInfoService {
    ...
    public Long login(String code) {
        //1.获取openid
        try {
            //根据code值和小程序id和小程序的密钥去请求微信接口返回openidid
            ...
            if(driverInfo==null){
                ...
                driverSet.setAcceptDistance(new BigDecimal(SystemConstant.ACCEPT_DISTANCE));//默认五公里
                driverSet.setIsAutoAccept(0);//0 不是 1 是
